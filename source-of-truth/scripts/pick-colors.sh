...
# --- Main Script ---
mkdir -p "$OUT_DIR" "$WAYBAR_CSS_DIR" "$QT6CT_DIR" "$HYPRLAND_DIR" "$ROFI_DIR"
...
* {
    /* Main Theme Colors */
    background:     rgba(0, 0, 0, 0); /* Fallback for transparent */
    background-alt: ${ACCENT2};
    foreground:     ${FG};
    selected:       ${ACCENT1};
...
listview {
    ...
    columns: 1;
    scrollbar: false;
    background-color: @background; /* Fully transparent */
    text-color: @foreground;
}
